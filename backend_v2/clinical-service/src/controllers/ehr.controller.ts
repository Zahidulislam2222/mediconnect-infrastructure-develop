...
// POST /ehr/upload-url - Get Presigned PUT URL
...
// POST /ehr/view-url - Get Presigned GET URL
router.post("/view-url", async (req: Request, res: Response) => {
...
export const ehrController = router;
